...
The V3.1 architecture baseline and implementation Milestones 0–5 are complete. Milestone 6 is active.
...
- Current work: Milestone 6 GitHub publication and revision-bound CI evidence
