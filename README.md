...
The V3.1 architecture baseline and implementation Milestones 0–2 are complete. Milestone 3 is active.
...
- Current work: Milestone 3 provider-neutral execution, capability negotiation, and normalized Agent Runs
