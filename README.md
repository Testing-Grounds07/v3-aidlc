...
The V3.1 architecture baseline and implementation Milestones 0–6 are complete. Milestone 7 is active.
...
- Current work: Milestone 7 human approval, revocable delegation, and plain-language liaison UX
