...
The V3.1 architecture baseline and implementation Milestones 0–3 are complete. Milestone 4 is active.
...
- Current work: Milestone 4 controlled orchestration, verification, independent review, and bounded repair
